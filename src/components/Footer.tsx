        ...
        <footer className="bg-footer pb-8 pt-12">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2 text-text-normal">
                            ...
                            <li>
                                <Link to="/temperature" className="hover:text-white transition-colors">
                                    Lernpfad 1: Versteht uns ein Sprachmodell?
                                </Link>
                            </li>
                            <li>
                                <Link to="/attention" className="hover:text-white transition-colors">
                    ...
                    <div>
                        <h4 className="text-primary text-lg font-semibold mb-4">Kontakt</h4>
                        <ul className="space-y-2 text-text-normal">
                            <li>
                ...
                <div className="border-t border-slate-700 mt-8 pt-4 text-center text-text-normal">
                    <p>&copy; {new Date().getFullYear()} Weiß die KI, dass sie nichts weiß?</p>
                </div>
            </div>
        </footer>
    );
