    ...
    return (
        <section className="neural-bg py-20 px-6">
            <div className="max-w-5xl mx-auto text-center">
                ...
                <p className="text-xl text-textNormal mb-8 max-w-4xl mx-auto leading-relaxed">
                    {subtitle}
                </p>
                ...
                {badges.length > 0 && (
                    <div className="flex items-center justify-center space-x-4 mb-12">
                        {badges.map((badge, index) => (
                            <div
                                key={index}
                                className="flex items-center space-x-2 bg-bgColor/80 backdrop-blur-sm px-4 py-2 rounded-full"
                            >
