  ...
  return (
    <section className="py-16 px-6 bg-white">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-3xl font-bold text-textDark mb-8 text-center">Tokenisierungs-Ansätze im Vergleich</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
          <button 
            onClick={() => setActiveExample("word")}
            className={`tokenization-example p-6 border-2 border-bgLightGray rounded-xl text-center hover:border-secondary transition-all duration-300 transform hover:scale-105 ${
          ...
          >
            ...
            <p className="text-textNormal text-sm">Jedes Wort wird als einzelnes Token behandelt</p>
          </button>
          <button 
            onClick={() => setActiveExample("subword")}
            className={`tokenization-example p-6 border-2 border-bgLightGray rounded-xl text-center hover:border-primary transition-all duration-300 transform hover:scale-105 ${
          ...
          >
            ...
            <p className="text-textNormal text-sm">Wörter werden in häufige Teilsequenzen zerlegt</p>
          </button>
          <button 
            onClick={() => setActiveExample("character")}
            className={`tokenization-example p-6 border-2 border-bgLightGray rounded-xl text-center hover:border-orange-500 transition-all duration-300 transform hover:scale-105 ${
          ...
          >
            <div className="w-16 h-16 flex items-center justify-center bg-orange-100 rounded-xl mx-auto mb-4">
              <i className="ri-font-size text-tertiary text-2xl"></i>
            </div>
            <h3 className="font-bold text-lg mb-2">Zeichen-basiert</h3>
            <p className="text-textNormal text-sm">Jedes Zeichen ist ein separates Token</p>
          </button>
        </div>
        ...
        <div className="bg-bghero p-8 rounded-xl">
          <div className="text-center mb-6">
            <h3 className="text-xl font-semibold text-textDark mb-2">Beispiel: "Maschinelles Lernen"</h3>
            <p className="text-textNormal">Siehe wie verschiedene Ansätze denselben Text tokenisieren</p>
          </div>
          <div className="space-y-6">
            {Object.entries(examples).map(([key, example]) => (
              ...
              >
                ...
                <p className="text-sm text-textNormal">{example.description}</p>
              </div>
            ))}
          </div>
        </div>
