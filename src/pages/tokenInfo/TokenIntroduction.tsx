      ...
      <div className="max-w-6xl mx-auto">
        <div className="max-w-6xl mx-auto mb-24">
          ...
          <p className="text-lg text-text-normal mb-6 leading-relaxed">
            Wenn Sie ChatGPT fragen, erhalten Sie sicher eine passende Antwort.
            Aber versteht das Modell dabei wirklich, was eine Brombeere ist? Um
            dieser Frage nachzugehen, lohnt sich ein Blick darauf, wie
            Sprachmodelle Texte überhaupt verarbeiten – und warum sie dafür auf
            eine mathematische Darstellung in Form von{" "}
            <strong className="text-primary">Tokens</strong> angewiesen sind.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <p className="text-lg text-text-normal mb-6 leading-relaxed">
              Damit ein Sprachmodell mit Sprache <Tilde />
              arbeiten kann, braucht es eine einheitliche und mathematisch
              verarbeitbare Darstellung des Textes. Reiner Text besteht aus
              Zeichen und Wörtern, mit denen alleine ein neuronales Netz erstmal
              nichts anfangen kann.
            </p>
            <div className="bg-primary/5 border-l-4 text-primary p-6 rounded-r-lg mb-6">
              <p className="text-textMedium font-medium">
                Ein <strong className="text-primary">Token</strong> kann ein
                Wort, eine Zeichensequenz, ein Satzzeichen oder sogar ein
                einzelnes Zeichen sein – je nach verwendetem Tokenizer.
              </p>
            </div>
          </div>
          <div className="p-8 rounded-xl">
            ...
            <div className="bg-bgColor p-4 rounded-lg border border-outline mb-4">
              ...
              <p className="text-text-normal font-mono">
                "Das Wetter heute ist besonders schön."
              </p>
            </div>
            <div className="bg-bgColor p-4 rounded-lg border border-outline">
              <p className="text-text-normal font-semibold text-sm text-textNormal mb-3">
                Tokens:
              </p>
