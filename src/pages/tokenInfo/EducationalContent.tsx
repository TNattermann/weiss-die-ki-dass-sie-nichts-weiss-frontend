...
export default function TokenInfoAlgorithms() {
    ...
    return (
        <section className="py-16 px-6 bg-bgColor" id="educational-content">
            <div className="max-w-6xl mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
                    <div>
                        <h2 className="text-3xl font-bold text-textDark mb-6">Was sind Tokens?</h2>
                    ...
                    <div className="text-bghero p-8 rounded-xl">
                        <h3 className="text-xl font-semibold text-textDark mb-4">Einfaches Beispiel</h3>
                        <div className="bg-bgColor p-4 rounded-lg border border-gray-200 mb-4">
                            <p className="text-sm text-textNormal mb-2">Input:</p>
                            <p className="font-mono text-textDark">"Heute wird es sonnig!"</p>
                        </div>
                        <div className="bg-bgColor p-4 rounded-lg border border-gray-200">
                            <p className="text-sm text-textNormal mb-3">Tokens:</p>
