        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-text-normal mb-6 leading-r>elaxed">
              ...
              Für <strong className="text-primary">jedes </strong> Gewicht wird dabei die Frage gestellt: Wie sehr verändert sich der Loss, wenn das Gewicht angepasst wird? 
            </p>
            ...
            <div className="bg-primary/5 border-l-4 text-primary p-6 rounded-r-lg mb-6">
              <p className="text-text-normal font-medium">
                ...
                und der nächste Trainingszyklus kann beginnen. 
              </p>
            </div>
