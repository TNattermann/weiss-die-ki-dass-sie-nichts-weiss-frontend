      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-8 sm:mb-12">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-primary mb-4 sm:mb-6 break-words">
            Woher <Tilde />
            weiß das Modell, was es anpassen muss?
          </h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-start md:items-center mb-6 sm:mb-8">
            <div>
              <p className="text-base sm:text-lg text-text-normal leading-relaxed break-words">
                Beim Bogenschießen gibt ein*e Trainer*in in Abhängigkeit von der
                beobachteten Distanz zum Ziel (der Loss){" "}
                <strong className="text-primary"> Rückmeldung</strong> in Form
                von konkreten
                <strong className="text-primary"> Anweisungen</strong>, welche
                Anpassungen (über den Gradientenabstieg) für den nächsten
                Versuch vorgenommen werden sollen. Dies geschieht in diesem Fall
                auf Grundlage von langjähriger Erfahrung der Trainerin bzw. des
                Trainers. Aber wie funktioniert das bei einer KI?
              </p>
            </div>
            ...
            <div className="flex justify-center md:justify-end">
              <video
                ...
                aria-label="Animation der Trainingsrückmeldung: Ein Ergebnis wird festgestellt und neue Handlungsanweisungen kommuniziert."
              />
            </div>
          </div>

          <p className="text-base sm:text-lg text-text-normal mb-6 leading-relaxed break-words">
            Auch die KI ermittelt ausgehend vom Loss, welche Anpassungen
            vorgenommen werden müssen. Das ist aber nicht so einfach wie beim
            Bogenschießen: Statt nur die Bogenspannung anzupassen, muss für
            ...
            (propagiert) wird. <br />
            Das kann man sich so vorstellen: Je{" "}
            <strong className="text-primary">näher</strong> das Gewicht am Ende
            des Netzes liegt, desto{" "}
            <strong className="text-primary">einfacher</strong> lässt sich
            dessen Anpassung bestimmen. Für{" "}
            <strong className="text-primary">jedes</strong> Gewicht wird dabei
            die Frage gestellt: Wie sehr verändert sich der Loss, wenn das
            Gewicht angepasst wird?
          </p>
          ...
          <div className="bg-primary/5 border-l-4 text-primary p-4 sm:p-6 rounded-r-lg mb-6">
            <p className="text-text-normal font-medium break-words">
              Nachdem wir die{" "}
              <strong className="text-primary">Backpropagation</strong>{" "}
              durchgeführt haben, erhalten wir unsere
              <strong className="text-primary"> Anpassungsanweisungen</strong>,
              die wir dann mit dem
          ...
          <div className="w-full flex justify-center mb-6">
            <video
              ...
              aria-label="Animation eines neuronalen Netzes, bei dem von hinten nach vorne Gewichtsanpassungen ermittelt werden."
            />
          </div>
          ...
          <Expandable title="Mehr zur Backpropagation" className="mb-6">
            ...
            <p className="text-text-normal leading-relaxed break-words">
              Die Backpropagation macht sich dabei die{" "}
              <strong className="text-primary">Struktur</strong> des Netzes
              zunutze: Die Darstellung als Netz mit Schichten entspricht
              mathematisch einer{" "}
              <strong className="text-primary">
                Verkettung von Funktionen
              </strong>
              : Wir stecken sozusagen die letzte Schicht in die vorletzte
              Schicht und so weiter, bis wir bei der ersten Schicht angekommen
              sind. Auch deshalb müssen wir mit der{" "}
              <strong className="text-primary">hintersten</strong> Schicht bei
              der Backpropagation beginnen, da diese das{" "}
              <strong className="text-primary">innerste</strong> Glied unserer
              Kette aus Schichten darstellt. Die Bestimmung der jeweiligen
              Ableitungen kann dann mit der{" "}
              <strong className="text-primary">Kettenregel</strong> erfolgen –
              falls sich daran noch jemand aus dem Matheunterricht erinnern
              kann!
            </p>
          </Expandable>
        </div>
