        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center mb-8">
                    <div>
                        <p className="text-lg text-text-normal leading-relaxed">
                            Möchten wir beim Bogenschießen ermitteln, wie gut ein Versuch war, muss die 
                            <strong className="text-primary"> Distanz</strong> der Pfeilspitze zur Mitte der Zielscheibe bestimmt werden.
            ...
            <p className="text-lg text-text-normal mb-6 leading-r>elaxed">
              Beim Trainieren einer KI schießt nicht ein*e Schütze*in auf eine Zielscheibe - stattdessen lernt die KI anhand
            ...
            <Expandable title="Mehr zu Verlustfunktionen" className="mb-6">
                ...
                <p className="text-text-normal leading-relaxed">
                Am Ende erfüllen allerdings alle denselben Zweck: Sie ermitteln die <strong className="text-primary">Abweichung zwischen Ist- 
                und Sollzustand</strong>. 
                Die Auswahl der Verlustfunktion ist dabei eine <strong className="text-primary">Modellierungsentscheidung</strong> der Entwickler*innen und sollte unter 
                Berücksichtigung des gesamten Prozesses und der Fragestellung gewählt werden.
                </p>
            </Expandable>
          </div>
        </div>
