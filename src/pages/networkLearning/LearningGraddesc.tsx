        ...
        <div className="mb-12">
          ...
          <div className="bg-primary/5 border-l-4 text-primary p-6 rounded-r-lg mb-6">
            <p className="text-text-normal font-medium">
              ...
              zunehmend zu verringern. Diese Anpasungen sind der{" "}
              <strong className="text-primary">
          ...
          <Expandable title="Mehr zum Gradientenabstieg" className="mb-6">
            <p className="text-text-normal leading-relaxed mb-4">
              ...
              Funktion berechnet werden. Diese Ableitung bestimmen dabei für
              jedes Gewicht, wie viel dessen Änderung zur Reduzierung des Losses
              beitragen kann. Als{" "}
              <strong className="text-primary">Gradient </strong>Gradient
              bezeichnet man die{" "}
              <strong className="text-primary">
                Sammlung dieser Ableitungen{" "}
              </strong>
              in einer kompakten Form, mathematisch bezeichnen wir dies als
              Vektor. Somit wird beim Gadientenabstieg der aktuelle Zustand der
            ...
            <p className="text-text-normal leading-relaxed">
              ...
              zu finden. Bei einem solchen Verfahren, dass eine optimale Lösung
