      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="items-center mb-16">
          <p className="text-lg text-text-normal mb-6 leading-relaxed">
            ...
            <Tilde />treffen würde. Probieren Sie auch aus, was geschieht, wenn Sie den
        ...
        <div className="bg-primary/5 border-l-4 text-primary p-6 rounded-r-lg mb-6">
          ...
          <p className="text-textMedium font-medium text-lg">
            ...
            Ergebnis größer als null, wird sich für den Kauf <Tilde />entschieden und
        ...
        <p className="text-lg text-text-normal mb-6 leading-relaxed">
          ...
          gewonnen, wie ein Modell eine Entscheidung <Tilde />trifft. Um genauer zu
