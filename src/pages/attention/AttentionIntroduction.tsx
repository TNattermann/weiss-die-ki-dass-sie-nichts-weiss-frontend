    ...
    <section className="py-6 px-6" id="educational-content">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-6">
          <div>
            <p className="text-lg text-text-normal mb-6 leading-relaxed">
              ...
              Satz <Tilde />vorhersagt. Nun gibt es Wörter, die für so ein Ratespiel
        ...
        <p className="text-lg text-text-normal mb-4 leading-relaxed mt-4">
          ...
          Wörter <Tilde />konzentrieren können - sonst geht der gesamte Kontext
          verloren. Doch woher <Tilde />weiß das Modell, welches Wort relevant ist und
          welches nicht?
        </p>
      </div>
    </section>
