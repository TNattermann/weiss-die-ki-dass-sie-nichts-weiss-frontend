  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <p className="text-lg text-text-normal mb-6 leading-relaxed">
        Eine gute Art sich das Konzept der Aufmerksamkeit vorzustellen, ist eine
        Analogie zur menschlichen Betonung zu ziehen. Nehmen wir an, dass die
        Betonung eines Wortes mit der Wichtigkeit für den Rest des Satzes
        gleichzusetzen ist. In folgenden Beispielen werden jeweils verschiedene
        Wörter betont - und somit ihre Wichtigkeit hervorgehoben.
      </p>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <p className="text-lg text-text-normal mb-6 leading-relaxed">
          <FileWithText
            ...
            text={
              <>
                ...
                <strong className="text-primary">heute</strong> sehr schön ist,
                oder heute <strong className="text-primary">sehr</strong> schön
                ist (oder beides).
              </>
            }
          />
      ...
      <p className="text-lg text-text-normal mb-6 leading-relaxed mt-6">
        Mit unterschiedlicher Betonung wird durch mehr Kontextinformationen die
        Bedeutung des Satzes klarer. Man sieht: Eine unterschiedliche Betonung
        kann die Wichtigkeit von Wörtern herausheben, und wir erkennen die
        Wichtigkeit von Wörtern auch anhand der Betonung. Ein Sprachmodell kann
        dies - wenn überhaupt - nur mit dem Text selbst ~erkennen, d.h.
      ...
      <div className="bg-primary/5 border-l-4 text-primary p-6 rounded-r-lg mb-6">
        <p className="text-text-normal font-medium">
          ...
          Betonung eines Wortes mit der Wichtigkeit eines Wortes gleichzusetzen
          ist schwierig. Es gibt Sätze, bei denen dies anders ist. Man sieht,
          dass es schwierig ist, das Konzept der Aufmerksamkeit intuitiv zu
          erklären.
        </p>
      </div>
    </div>
