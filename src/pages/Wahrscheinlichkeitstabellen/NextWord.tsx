...
const wordlibrary = [
    {
        id: "0",
        list: [[" schön", 0.45 ], [" warm", 0.30], [" kalt", 0.25] ]
    },
    {
        id: " schön",
        list: [[".", 0.21 ], [" und", 0.12], [" für", 0.06], [" hier", 0.009]]
    },
    {
        id: " warm",
        list: [[" und", 0.46], [".", 0.10 ], [" gewesen", 0.06], [" hier", 0.009]]
    },
    {
        id: " kalt",
        list: [[" und", 0.27], [".", 0.21 ], [" gewesen", 0.03], [" hier", 0.009]]
    },
    {
        id: " Banane",
    ...
    {
        id: " und",
        list: [[" trocken", 0.45 ], [" sonnig", 0.3], [" windig", 0.25], [".", 0.05]]
    ...
    {
        id: " für",
        list: [[" einen", 0.24 ], [" Radfahren", 0.019], [" Menschen", 0.009], [".", 0.005]]
    },{
        id: " hier",
        list: [["in", 0.45 ], [".", 0.06], [" oben", 0.04], [" und", 0.007]]
    },
    {
        id: " aufwärts",
        list: [[".", 0.17 ], [" und", 0.05], [" in", 0.04], [" gewesen", 0.019]]
    },
    {
        id: " gewesen",
        list: [[".", 0.39 ], [" und", 0.13], [" in", 0.01], [" mit", 0.0025]]
    },
    {
        id: " trocken",
        list: [[".", 0.36 ], [" gewesen", 0.038], [" in", 0.025], [" und", 0.017]]
    },
    {
        id: " sonnig",
        list: [[".", 0.36 ], [" gewesen", 0.038], [" in", 0.025], [" und", 0.017]]
    ...
    {
        id: " windig",
        list: [[".", 0.45 ], [" gewesen", 0.05], [" in", 0.03], [" und", 0.02]]
    },
    {
        id: " frostig",
        list: [[".", 0.45 ], [" gewesen", 0.05], [" in", 0.03], [" und", 0.02]]
...
export default function NextWord() {
    ...
    return (
            <div className="max-w-6xl mx-auto">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center text-primary mb-6">Und das nächste Wort?</h1>
                <div className="mb-16">
                    <div>
                        ...
                        <div className="py-6 flex justify-center">
                            <MultiTestRad wordlibrary={wordlibrary} temperature={1} isVideo={true}/>
                        </div>
                    </div>
                </div>
