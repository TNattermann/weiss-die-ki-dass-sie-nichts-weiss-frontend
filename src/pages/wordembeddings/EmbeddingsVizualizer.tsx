...
const embeddings = {
  // Monarchie
    ...
    Prinzessin: [-0.1662, 0.1910] as [number, number],
...
// Familie
    ...
    Tochter: [-0.3115, 0.0310] as [number, number],
  ...
  // Wetter
    ...
    Regen: [-0.0888, 0.1080] as [number, number],
  ...
  //Eigenschaften
    ...
    nass: [0.2241, -0.0440] as [number, number],
    kühl: [0.1458, 0.1190] as [number, number],
 ...
 // Hauptstätte
    ...
    Canberra: [-0.1199, 0.2100] as [number, number],
...
// Länder
    ...
    Spanien: [-0.1395, 0.2060] as [number, number],
    VereinigtesKönigreich: [-0.1292, 0.1860] as [number, number],
    Österreich: [-0.1839, 0.1139] as [number, number],
    USA: [-0.2390, 0.1325] as [number, number],
    Japan: [-0.1854, 0.1679] as [number, number],
    Kanada: [-0.1740, 0.1911] as [number, number],
    Australien: [-0.1721, 0.2440] as [number, number],
  ...
  return (
    <section className="py-16 px-6" id="visualizer">
        ...
        <div className="gap-12 shadow-lg items-center mb-16">
            <WordEmbeddingViz embeddings={embeddings} groups={groups} initialWords={[]} />
        </div>
        <div className="bg-primary/5 border-l-4 text-primary p-6 rounded-r-lg mb-6">
            <p>
                In Wirklichkeit bestehen Worteinbettungen aus hunderten von Zahlen, also Koordinaten in einem hochdimensionalen Raum.
